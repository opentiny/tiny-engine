...
>
> 升级前请先阅读 [v2.7 更新日志](./changelog)，了解 v2.7 版本的变更内容。
...
详细内容请参考 [新注册表](../extension-capabilities-overview/new-registry)。
...
详细API请参考 [注册表 API](../api/frontend-api/registry-api)。
...
详细内容请参考 [布局配置](../api/frontend-api/global-layout-api)。
...
详细内容请参考 [注册表高级配置](../extension-capabilities-overview/new-registry-advanced)。

...
![](./imgs/java/image36.png)

**步骤二 在步骤一新建的连接上右键选择“新建数据库”->输入数据库名称**

如下图所示

![](./imgs/java/image37.png)
...
![](./imgs/java/image40.png)

前后端启动成功后页面会自动弹出，如下可看连接数据库数据接口调通能返回正常数据

![](./imgs/java/image41.png)

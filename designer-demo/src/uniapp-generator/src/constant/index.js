...
const HARMONY_TAB_BAR = 'HarmonyTabBar'

const HARMONY_SWIPER_ITEM = 'HarmonySwiperItem'
...
export { DEFAULT_COMPONENTS_MAP, BUILTIN_COMPONENT_NAME, TINY_ICON, UNWRAP_QUOTES, HARMONY, HARMONY_TAB_BAR }
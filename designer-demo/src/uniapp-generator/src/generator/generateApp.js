...
/**
 * 整体应用出码
 * @param {import('@opentiny/tiny-engine-dsl-uniapp').IConfig} config
 * @returns {import('@opentiny/tiny-engine-dsl-uniapp').codeGenInstance}
 */

const generateUniappApp = (config = {}) => {
...
const generateAppCode = async (appSchema, options = {}) => {
  const instance = generateUniappApp({ ...defaultOptions, ...options })

<template>
  ...
  <div class="model-table-wrap">
    <tiny-grid ref="modelListRef" :data="modelList" :loading="gridLoading" @radio-change="selectModel">
      <tiny-grid-column type="radio" width="30"></tiny-grid-column>
      <tiny-grid-column field="name" title="模型名称" width="170" show-overflow></tiny-grid-column>
      <tiny-grid-column field="description" title="模型描述" show-overflow></tiny-grid-column>
      <!-- <tiny-grid-column field="modelVersion" title="版本" width="90" show-overflow>
...
import { getModelList } from '../common/http'

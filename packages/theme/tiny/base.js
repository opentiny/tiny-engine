export const tinyBaseSmbTheme = {
  ...
  'ti-base-color-common-12': '#2f2f2f', // 中立色-12
  'ti-base-color-common-11': '#1f1f1f', // 中立色-12
  'ti-base-color-common-10': '#191919', // 中立色-11
  ...
  'ti-base-color-common-0': '#dbdbdb', // 中立色-0

  /* 1.3 背景色*/
  'ti-base-color-bg-10': 'rgba(0, 0, 0, 0.05)',
  ...
  /* 1.4 功能色*/
  'ti-base-color-error-5': '#f23030', // 错误-5
   ...
   * 2.1 其他色
   **/
  'ti-base-color-gray-1': '#d3d4d6',
  'ti-base-color-gray-2': '#808080',
  'ti-base-color-gray-3': '#e9e9e9',
  'ti-base-color-gray-4': '#e6e6e6',
  'ti-base-color-gray-5': '#d9d9d9',
  'ti-base-color-gray-6': '#5e5e5e',
  'ti-base-color-gray-7': '#c2c2c2',
  'ti-base-color-gray-8': '#595959',
  'ti-base-color-gray-9': '#f2f2f2',
  'ti-base-color-gray-10': '#f2f5fc',
  'ti-base-color-gray-11': '#f5f5f5',
  'ti-base-color-gray-12': '#f0f0f0',
  'ti-base-color-blue-1': '#a0cfff',
  'ti-base-color-blue-2': '#1476ff',
  'ti-base-color-green-1': '#a6c3b9',
  'ti-base-color-brown-1': '#d3c6a2',
  'ti-base-color-pale-1': '#d8bab5',
  'ti-base-color-reddish-1': '#bfbfbf',
  'ti-base-color-black-1': '#999999',
  'ti-base-color-black-2': '#212121',
  'ti-base-color-black-3': '#404040',
  'ti-base-color-black-4': '#4d4d4d',
  'ti-base-color-black-5': '#222222',
  'ti-base-color-black-6': '#262626',
  ...
  'ti-common-color-error-border-1': 'var(--ti-base-color-error-5)', // 错误-校验边框色1
  ...
  'ti-common-color-info-border': 'var(--ti-base-color-gray-1)', // 信息-边框色
  'ti-common-color-info-text-2': 'var(--ti-base-color-gray-2)',
  ...
  // 其他边框颜色
  'ti-common-color-gray-border': 'var(--ti-base-color-common-0)',
  /**
   * 2.3 交互类型颜色
  ...
  'ti-common-color-primary-disabled': 'var(--ti-base-color-blue-1)', // NewCssVar
  'ti-common-color-primary-disabled-bg-color': 'var(--ti-common-color-bg-disabled)', // NewCssVar
  ...
  'ti-common-color-primary-plain-disabled-bg-color': 'rgba(191, 191, 191, 0.1)', // NewCssVa'
  ...
  'ti-common-color-success-disabled': 'var(--ti-base-color-green-1)', // NewCssVar
  'ti-common-color-success-disabled-bg-color': 'var(--ti-common-color-bg-disabled)', // NewCssVar
  ...
  'ti-common-color-success-plain-disabled-bg-color': 'rgba(166, 195, 185, 0.1)', // NewCssVa'
  ...
  'ti-common-color-warning-disabled': 'var(--ti-base-color-brown-1)', // NewCssVar
  'ti-common-color-warning-disabled-bg-color': 'var(--ti-common-color-bg-disabled)', // NewCssVar
  ...
  'ti-common-color-warning-plain-disabled-bg-color': 'rgba(211, 198, 162, 0.1)', // NewCssVa'
  ...
  'ti-common-color-danger-disabled': 'var(--ti-base-color-pale-1)', // NewCssVar
  'ti-common-color-danger-disabled-bg-color': 'var(--ti-common-color-bg-disabled)', // NewCssVar
  ...
  'ti-common-color-danger-plain-disabled-bg-color': 'rgba(216, 186, 181, 0.1)', // NewCssVa'
  ...
  'ti-common-color-info-disabled': 'var(--ti-base-color-reddish-1)', // NewCssVar
  'ti-common-color-info-disabled-bg-color': 'var(--ti-common-color-bg-disabled)', // NewCssVar
  ...
  // 其他边框色
  'ti-common-color-border-1': 'var(--ti-base-color-gray-7)',
  'ti-common-color-border-2': 'var(--ti-base-color-gray-8)',
  'ti-common-color-border-3': 'var(--ti-base-color-gray-12)',
  ...
  'ti-common-color-text-dark-bg': 'var(--ti-base-color-common-2)', // 深色背景下文本信息
  'ti-common-color-text-dark-bg-disabled': 'var(--ti-base-color-common-5)', // 深色背景下文本信息禁用色
  'ti-common-color-text-link': 'var(--ti-base-color-brand-7)', // 链接色
  'ti-common-color-text-link-hover': 'var(--ti-base-color-brand-8)', // 链接悬浮色
  'ti-common-color-text-link-dark-bg': 'var(--ti-base-color-brand-4)', // 深色背景链接色
  'ti-common-color-text-link-dark-bg-hover': 'var(--ti-base-color-brand-3)', // 深色背景链接悬浮色
  ...
  'ti-common-color-text-dark-color': 'var(--ti-base-color-common-10)',
  'ti-common-color-text-dark-color-1': 'var(--ti-base-color-common-11)',
  'ti-common-color-text-gray-color-1': 'var(--ti-base-color-gray-5)',
  'ti-common-color-text-gray-color-2': 'var(--ti-base-color-gray-6)',
  'ti-common-color-text-gray-color-3': 'var(--ti-base-color-gray-7)',
  'ti-common-color-text-gray-color-4': 'var(--ti-base-color-gray-8)',
  'ti-common-color-text-gray-color-5': 'var(--ti-base-color-gray-12)',
  /**
   * 2.5 图标色
   **/
  ...
  // 灰色背景下图标色
  'ti-common-color-icon-gray-bg-normal': 'var(--ti-base-color-common-2)',
  'ti-common-color-icon-gray-bg-hover': 'var(--ti-base-color-brand-6)',
  'ti-common-color-icon-gray-bg-active': 'var(--ti-base-color-brand-6)',
  'ti-common-color-icon-gray-bg-disabled': 'var(--ti-base-color-common-1)',

  // 深底背景图标色
  'ti-common-color-icon-dark-bg-normal': 'var(--ti-base-color-common-2)',
  'ti-common-color-icon-dark-bg-hover': 'var(--ti-base-color-brand-5)',
  'ti-common-color-icon-dark-bg-active': 'var(--ti-base-color-brand-5)',
  'ti-common-color-icon-dark-bg-disabled': 'var(--ti-base-color-common-5)',
  ...
  'ti-common-color-bg-gray-2': 'var(--ti-base-color-gray-3)',
  'ti-common-color-bg-gray-3': 'var(--ti-base-color-gray-4)',
  'ti-common-color-bg-secondary': 'var(--ti-base-color-common-2)', // 开关组件-关闭状态-背景色
  'ti-common-color-bg-light': 'var(--ti-base-color-bg-10)',
  'ti-common-color-bg-light-1': 'var(--ti-base-color-gray-9)',
  'ti-common-color-bg-light-2': 'var(--ti-base-color-gray-10)',
  'ti-common-color-bg-light-3': 'var(--ti-base-color-gray-11)',
  'ti-common-color-bg-blue-1': 'var(--ti-base-color-blue-2)',
  'ti-common-color-bg-dark': 'var(--ti-base-color-common-10)',
  ...
  'ti-common-color-bg-dark-1': 'var(--ti-base-color-common-12)',
  'ti-common-color-bg-dark-2': 'var(--ti-base-color-black-2)',
  'ti-common-color-bg-dark-3': 'var(--ti-base-color-black-3)',
  'ti-common-color-bg-dark-4': 'var(--ti-base-color-black-4)',
  'ti-common-color-bg-dark-5': 'var(--ti-base-color-black-5)',
  'ti-common-color-bg-dark-6': 'var(--ti-base-color-black-6)',
  /* 顶部导航背景色,用于navMenu*/
  ...
  /**
   * 2.8 行高
   * TinyNG只有一个1.5倍的行高,其余行高抽出来是为了适配，但是全局都是1.5倍行高可以保持风格统一
   */
   ...
   * 2.12 字号
   **/
  'ti-common-font-size-0': '11px', // engine定义的
  ...
  /* 以下变量是因为拥有大量的large、medium、normal、minor、samll、mini尺寸， 所以下方是一些抽象尺寸、为了更好的适配 (button、tag、alert组件) */
  ...
  'ti-common-scrollbar-thumb-bg-color': 'var(--ti-base-color-reddish-1)',
  'ti-common-scrollbar-thumb-hover-bg-color': 'var(--ti-base-color-black-1)',
  'ti-common-scrollbar-thumb-active-bg-color': 'var(--ti-base-color-black-1)'
}

export * from './light-component.js'

export * from './dark-component.js'

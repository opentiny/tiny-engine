    ...
    >
      ...
      >
        <tiny-form-item label="名称" prop="name_cn">
          <TinyInput v-model="formData.name" placeholder="请输入"></TinyInput>
        </tiny-form-item>
        <tiny-form-item label="前缀" prop="label">
          <TinyInput v-model="formData.prefix" placeholder="请输入"></TinyInput>
        </tiny-form-item>
        <tiny-form-item label="导入" prop="label">

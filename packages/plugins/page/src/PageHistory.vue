...
import { usePage, useBlock, useModal, getMetaApi } from '@opentiny/tiny-engine-meta-register'
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const getHistoryList = (pageId) => {
      const { id, version } = getMetaApi('engine.service.globalService').getBaseInfo()

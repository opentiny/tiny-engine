...
// 移除 import { capitalize, hyphenate } from '@vue/shared'
// 本地实现 capitalize
const capitalize = (str) => str.charAt(0).toUpperCase() + str.slice(1)
// 本地实现 hyphenate
const hyphenate = (str) => str.replace(/([A-Z])/g, '-$1').toLowerCase()
import { tinyIcon as unifyIconName } from '../pre-processor'
import { TINY_ICON, JS_FUNCTION } from '../constant'
import { formatCode, formatFiles, checkFormat } from './formatCode'

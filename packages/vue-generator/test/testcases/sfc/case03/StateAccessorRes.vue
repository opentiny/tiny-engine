...
<tiny-input placeholder="请输入全名" v-model="state.fullName"></tiny-input></tiny-form-item>
<tiny-form-item >
<tiny-button text="提交" type="primary"></tiny-button>
<tiny-button text="重置" style="margin-left: 10px"></tiny-button></tiny-form-item></tiny-form></div></template>

<script setup>
import { Form as TinyForm,FormItem as TinyFormItem,Button as TinyButton } from "@opentiny/vue"

...
<tiny-input placeholder="请输入姓氏" v-model="state.lastName"></tiny-input></tiny-form-item>
<tiny-form-item label="名">
<tiny-input placeholder="请输入名字" v-model="state.firstName"></tiny-input></tiny-form-item>
<tiny-form-item >

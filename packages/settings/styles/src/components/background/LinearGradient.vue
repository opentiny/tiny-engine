      ...
      <div class="angle-icon">
        <div>
          <svg
            ...
            class="rotate-svg"
          >
            <circle cx="11" cy="11" r="11" fill="#DBDBDB"></circle>
        ...
        <span @click="counterclockwiseRotate"><svg-icon name="clock-wise-counter" color="#DBDBDB"></svg-icon></span>
        <span @click="clockwiseRotate"><svg-icon name="clock-wise" color="#DBDBDB"></svg-icon></span>
      </div>
      <input-select
